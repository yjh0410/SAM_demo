...
# ---------------------------- AutoMaskGenerator parser parameter ----------------------------
...
def write_masks_to_folder(masks: List[Dict[str, Any]], path: str) -> None:
    header = "id, area, bbox_x0, bbox_y0, bbox_w, bbox_h, \
              ...
              crop_box_x0, crop_box_y0, crop_box_w, crop_box_h"  # noqa
    metadata = [header]
...
def main(args: argparse.Namespace) -> None:
    ...
    for t in targets:
        ...
        print(" - Infer time: {:3f} s".format(time.time() - t0))
        ...
        if args.show:
            ...
            for object in masks:
                ...
                image = (image * inv_alph_mask +  mask_rgb).astype(np.uint8)
